...
public class StableDiffusionText2Image : StableDiffusionGenerator {
    ...
    [SerializeField] private Image showingImage;
    public string SavingImageName;
    ...
    void SetupFolders() {
        ...
        try {
            ...
            //filename = Path.Combine(mat, SavingImageName + ".png");
            string streamingAssetsPath = Application.streamingAssetsPath;
            string saveLocation = CardMaster.Instance.SDImagePath;
            filename = saveLocation + SavingImageName + ".png";
    ...
    IEnumerator GenerateAsync() {
        ...
        try {
            ...
            //added by arnold
            httpWebRequest.Timeout = 1000 * 300; // 300 秒（5 分鐘）
